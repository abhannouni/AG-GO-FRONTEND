...
const footerLinks = {
    Destinations: ['Marrakech', 'Sahara Desert', 'Chefchaouen', 'Fes', 'Atlas Mountains', 'Essaouira'],
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-sm leading-relaxed max-w-xs mb-6">
                            Your trusted guide to the wonders of Morocco. Discover authentic
                            experiences crafted by local experts.
                        </p>
                        {/* Social Links */}
                        <div className="flex gap-3">
                            {socialLinks.map((s) => (
                                <a
                                    ...
                                    aria-label={s.label}
                                    rel="noreferrer"
                                    className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-forest-600 hover:text-white transition-all duration-200"
                                >
                                    {s.icon}
                                </a>
                            ))}
            ...
            <div className="border-t border-white/10">
                <div className="container mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
                    <p className="text-xs text-center md:text-left">
                        © 2026 AfGo Morocco Travel. All rights reserved.
                    </p>
